...
<footer>
    <section class="wrapper3">
        <div class="footer">
            <div id="address">
                <h2><a href="<?php echo home_url(); ?>">アニエラ</a></h2>
                <h3>株式会社アニエラ</h3>
                <div>
                    <address>〒399-0001<br>長野県松本市宮田5-13</address>
                    <p>長野県公安委員会許可 古物商許可 第481331700007号</p>
                    <a href="<?php echo esc_url(home_url('ec/contact')); ?>"><svg aria-label="Contact" viewBox="0 0 134 24.1"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#contact_link"></use></svg></a>
                </div>
            </div>
            <nav class="footerNav">
                <div>
        ...
        <div id="copyright" class="wrapper1">&copy;ANIERA.</div>
    </section>
</footer>
<!-- <div id="cursor"></div> -->
<?php wp_footer(); ?>
